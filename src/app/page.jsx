    ...
    <main className="flex min-h-screen flex-col bg-white">
      ...
      <div className="flex grow flex-col md:flex-row bg-customBackground">
        ...
        <p className={`text-xl text-gray-800 md:text-3xl md:leading-normal`}>
          ...
          <Link
            href="/counter"
            className="flex items-center gap-5 self-start rounded-lg bg-customPurple px-6 py-3 text-sm font-medium text-white transition-colors hover:bg-blue-400 md:text-base"
          >
